    ...
    <DefaultLayout>
      <div className={styles.flex}>
        ...
        <div className={styles.bottom}>
          <SectionTeam>
            <strong>Anastasiya Uraleva</strong>, <strong>Andrew Alimbuyuguen</strong>, <strong>Jimmy Lee</strong> and friends are computer aficionados at heart. They live and
            breathe making websites and graphics. They look forward to the next opportunity to build alongside teams that are improving the world.
          </SectionTeam>
