...
void main () {
  ...
  vec3 splatColor = vec3(1.0, 0.254, 0.0); // Bright neon orange
vec3 backgroundColor = vec3(0.412, 0.412, 0.412);
    ...
    function update() {
      ...
      if (canvas) {
        if (timeAccumulator >= config.SPEED) {
          timeAccumulator = 0;
          splat(canvas.width * 0.5, canvas.height, -24, -canvas.height * 2);
        }
      }
